...
//Rifle Platoon
	...
	case "TL" : { // FT Leader
		...
		addMagazines("HandGrenade_West",2);
		addMagazines("1Rnd_HE_M203",6);
		addWeapons ["M16A4_ACG_GL","ACE_Rucksack_MOLLE_WMARPAT"];
		addItems ["R","B","N","M","L"];
	...
	case "AAR": { // Greanadier - Assistant Automatic Rifleman
		...
		addMagazines("SmokeShell",2);
		addMagazines("HandGrenade_West",2);
		addWeapons ["ACE_M16A4_Iron","ACE_Rucksack_MOLLE_WMARPAT"];
		addItems ["R","B","N","L"];
	...
	case "MED": { // Medic
		...
		addWeapons ["ACE_M16A4_Iron","ACE_Rucksack_MOLLE_WMARPAT_Medic"];
		addItems ["R","L","N"];
...
//224mm Mortar Squad
	...
	case "MOAG224" : { //224mm Mortar Asst. Gunner
		...
		addItems ["R","N","B","E","L"];
		_unit setVariable ["ACE_weapononback","ACE_Rucksack_MOLLE_WMARPAT"];
	...
	case "MOAB224" : { //224mm Mortar Ammo Bearer
		...
		addWeapons ["ACE_M4","ACE_Rucksack_MOLLE_WMARPAT"];
		addItems ["R","N","E","L"];
...
//Assault Section
	...
	case "ASAG" : { // Assistant Gunner
		...
		addWeapons ["ACE_M4_Aim","ACE_Rucksack_MOLLE_WMARPAT","ACE_Rangefinder_OD"];
		addItems ["R","L","N","E"];
...
//Force Recon
	...
	case "FR_DM" : {// Marksman
		...
		addMagazines("ACE_Battery_Rangefinder",2);
		addMagazines("30Rnd_556x45_Stanag",4);
		addWeapons ["TU_M40A5_SD","ACE_Rangefinder_OD","ACE_Rucksack_MOLLE_WMARPAT"];
	...
	case "FR_DEMO": { // Demoman
		...
		addMagazines("SmokeShell",2);
		addMagazines("HandGrenade_West",2);
		addWeapons ["ACE_SOC_M4A1_AIM_SD","ACE_Rucksack_MOLLE_WMARPAT"];
	...
	case "FR_GL": { // Greanadier
		...
		addMagazines("1Rnd_HE_M203",6);
		addWeapons ["ACE_SOC_M4A1_EOT_SD","ACE_Rucksack_MOLLE_WMARPAT"];
		addItems ["R","N","L","M"];
	...
	case "FR_CM": { // Medic
		addMagazines("30Rnd_556x45_Stanag",8);
		addMagazines("SmokeShell",4);
		addWeapons ["ACE_SOC_M4A1_SD_9","ACE_Rucksack_MOLLE_WMARPAT_Medic"];
		addItems ["R","L","N","M"];
		_unit setVariable ["ACE_RuckMagContents",[["ACE_Bandage",5],["ACE_Morphine",5],["ACE_Medkit",4]]];
	};
//Snipers	
