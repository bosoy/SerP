...
switch _loadout do {
	case "BMD" : { //
		...
		_veh addWeaponCargo ["ACE_Rucksack_RD54",1];
	...
	case "BMD_AA" : { //
		...
		_veh addWeaponCargo ["ACE_GlassesLHD_glasses",1];
		[_veh,"545M_BIG"] call SerP_cargoCrateProcessor;
		[_veh,"GP25_AMMO"] call SerP_cargoCrateProcessor;
	};
	case "UAZ_E" : { //
	...
	case "TRUCK_MORTAR" : { //
		...
		_veh addMagazineCargo ["ACE_Morphine",9];
		_veh addMagazineCargo ["ACE_Epinephrine",9];
		_veh addWeaponCargo ["ACE_2b14Proxy",2];
		_veh addWeaponCargo ["ACE_2b14TripodProxy",2];
		_veh addWeaponCargo ["ace_arty_rangeTable_2b14_legacy",2];
		[_veh,"82MMHE",4] call SerP_cargoCrateProcessor;
		[_veh,"82MMWP",2] call SerP_cargoCrateProcessor;
		[_veh,"82MMIL",3] call SerP_cargoCrateProcessor;
	};
	case "TRUCK_MG" : { //
		_veh addMagazineCargo ["HandGrenade_East",12];
		_veh addMagazineCargo ["ACE_RDGM",10];
		...
		_veh addMagazineCargo ["ACE_Epinephrine",7];
		[_veh,"762X54B",4] call SerP_cargoCrateProcessor;
		[_veh,"545M_BIG",2] call SerP_cargoCrateProcessor;
	};
	case "TRUCK_KONKURS" : { //
		_veh addMagazineCargo ["HandGrenade_East",12];
		_veh addMagazineCargo ["ACE_RDGM",10];
