_cargoCrate_processor = {
	...
	//RUS
		...
		{
			[_veh,"ACE_Tbox_RU",[["AT13",3]]] call _addCargoBox;
		};
		case "9M131" : {// 9К131 Metis-M Ammo TB
		{
			[_veh,"ACE_Tbox_RU",[["ACE_AT13TB",3]]] call _addCargoBox;
		};
		case "9P151" : {// 9K113 Metis-M Launcher
		{
			[_veh,"ACE_Tbox_RU",[],[["MetisLauncher",3]]] call _addCargoBox;
		};
		case "9M113" : {// 9K113 Konkurs-M Ammo
		{
			[_veh,"ACE_Tbox_RU",[["ACE_KonkursM_CSWDM",3]]] call _addCargoBox;
		};		
		case "9P135" : {// 9K113 Konkurs-M Launcher
		{
			[_veh,"ACE_Tbox_RU",[],[["ACE_KonkursTripodProxy",3]]] call _addCargoBox;
		};
