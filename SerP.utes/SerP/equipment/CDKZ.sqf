...
//командование взвода
	case "OFF" : { //Командир взвода
		addWeapons ["AK_74","ACE_P159_RD90","Makarov","Binocular","NVGoggles"];
...
//МСВ
	...
	case "SL_GP" : { //Комод с ГП
		addWeapons ["AK_74_GL","ACE_P159_RD90","Binocular","NVGoggles"];
		addWeapons ["ACE_Map","ACE_Map_Tools","ItemGPS"];
		addMagazines("30Rnd_545x39_AK",6);
		addMagazines("ACE_30Rnd_545x39_T_AK",2);
		addMagazines("ACE_RDGM",2);
	...
	case "TL" : { //Старший стрелок
		addWeapons ["AKS_74_pso","ACE_RPG27","Binocular","NVGoggles"];
	...
	case "AMG" : { //Помошник пулеметчика
		addWeapons ["AK_74","ACE_Rucksack_RD90","Binocular","NVGoggles"];
		addWeapons ["ACE_Earplugs"];
	...
	case "AT" : { //1й номер расчета РПГ
		addWeapons ["AK_74","ACE_RPG7V_PGO7","NVGoggles"];
		addWeapons ["ACE_Earplugs"];
		addMagazines("30Rnd_545x39_AK",6);
	...
	case "GLAT" : { //Стрелок с ГП РПГ18
		addWeapons ["AK_74_GL","RPG18","NVGoggles"];
		addMagazines("30Rnd_545x39_AK",7);
		addMagazines("ACE_30Rnd_545x39_T_AK",1);
		addMagazines("ACE_RDGM",2);
		addMagazines("HandGrenade_East",2);
	...
	case "LAT" : { // Стрелок РПГ-18
		addWeapons ["AK_74","RPG18","NVGoggles"];
		addMagazines("30Rnd_545x39_AK",7);
		addMagazines("ACE_30Rnd_545x39_T_AK",1);
		addMagazines("ACE_RDGM",2);
		addMagazines("HandGrenade_East",2);
...
//отделение ПТУР
	case "ATGM" : { //Старший оператор
		addWeapons ["AK_74","MetisLauncher","NVGoggles"];
		addWeapons ["ACE_Map","ACE_Map_Tools","ACE_Earplugs"];
		addMagazines("30Rnd_545x39_AK",6);
		addMagazines("AT13",1);
	};
	...
	case "HAT" : { //1й номер расчета РПГ-29
		addWeapons ["AK_74","ACE_RPG29","NVGoggles"];
		addWeapons ["ACE_Earplugs"];
		addMagazines("30Rnd_545x39_AK",6);
		addMagazines("ACE_RPG29_PG29",3);
	};
	case "AHAT" : { //2й номер расчета РПГ-29
		addWeapons ["AK_74","ACE_Rucksack_RD90","ACE_YardAge450","NVGoggles"];
		addWeapons ["ACE_Earplugs"];
		addMagazines("ACE_Battery_Rangefinder", 2);
		addMagazines("30Rnd_545x39_AK",7);
		addMagazines("ACE_30Rnd_545x39_T_AK",1);
...
//расчет миномета
	case "MOG" : { //Старший наводчик
		addWeapons ["AK_74","ACE_2b14Proxy","NVGoggles"];
	...
	case "MOAG" : { //Наводчик
		addWeapons ["AK_74","ACE_2b14TripodProxy","Binocular","NVGoggles"];
		addWeapons ["ACE_Earplugs"];
		addMagazines("30Rnd_545x39_AK",4);
		addMagazines("ACE_RDGM",2);
		addMagazines("ACE_2B14HE_CSWDM",2);
...
//отделение АГС
	case "AGL" : { //Старший наводчик
		addWeapons ["AK_74","ACE_AGS30Proxy","NVGoggles"];
		addWeapons ["ACE_Earplugs","ACE_Map","ACE_Map_Tools","ItemGPS"];
		addMagazines("30Rnd_545x39_AK",4);
		addMagazines("ACE_RDGM",2);
	...
	case "AGLAG" : { //Наводчик
		addWeapons ["AK_74","ACE_AGS30TripodProxy","Binocular","NVGoggles"];
		addWeapons ["ACE_Earplugs"];
		addMagazines("30Rnd_545x39_AK",4);
		addMagazines("ACE_RDGM",2);
		addMagazines("ACE_AGS30_CSWDM",2);
...
//отделение сбора и эвакуации раненых
	case "MED_SL" : { //Командир отделения - санитарный инструктор
		addWeapons ["AK_74","ACE_Rucksack_MOLLE_DMARPAT_Medic","NVGoggles"];
		addWeapons ["ACE_Map"];
