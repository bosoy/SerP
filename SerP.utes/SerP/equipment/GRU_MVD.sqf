...
//командование взвода
	case "OFF" : { //Командир взвода
		addWeapons ["ACE_AK74M_GL_PSO","ACE_P159_RD90","Makarov","Binocular","NVGoggles"];
...
//МСВ
	...
	case "TL" : { //Старший стрелок
		addWeapons ["ACE_AK74M_GL_Kobra","ACE_RPG22","Binocular","NVGoggles"];
	...
	case "AMG" : { //Помошник пулеметчика
		addWeapons ["ACE_AK74M_Kobra","ACE_Rucksack_RD90","Binocular","NVGoggles"];
		addWeapons ["ACE_Earplugs"];
	...
	case "LAT" : { // Стрелок РПГ-22
		addWeapons ["ACE_AK74M","ACE_RPG22","NVGoggles"];
		addMagazines("30Rnd_545x39_AK",7);
		addMagazines("ACE_30Rnd_545x39_T_AK",1);
		addMagazines("ACE_RDGM",2);
		addMagazines("HandGrenade_East",2);
...
//разведотделение
	...
	case "R_TL" : { //Старший разведчик
		addWeapons ["ACE_AKS74P_PSO","ACE_RPG27","ACE_APSB","Binocular","NVGoggles"];
		addWeapons ["ACE_Map","ACE_Map_Tools","ItemGPS"];
		addMagazines("30Rnd_545x39_AK",6);
		addMagazines("ACE_30Rnd_545x39_T_AK",2);
	...
	case "R_SAP" : { // Разведчик - сапер
		addWeapons ["ACE_AKS74P_Kobra","ACE_Rucksack_RD90","NVGoggles"];
		addWeapons ["ACE_Map"];
...
// отделение снаперское
	...
	case "ASN" : { //наблюдатель-наводчик
		...
		addMagazines("ACE_MON50_M",2);
		_unit setVariable ["ACE_weapononback","ACE_Rucksack_RD90"];
		_unit setVariable ["ACE_RuckMagContents",[["10Rnd_762x54_SVD",5],["ACE_MON50_M",3]]];		
	};
